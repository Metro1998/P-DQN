...
class FreewheelingIntersectionEnv_v1(gym.Env):
    ...
    Description:
        ...
        Hence you may execute one specific stage repeatedly before the others are executed.
        When one particular phase is over, it's time to decide(choose action) which stage(DISCRETE) to execute and its
    ...
    -------------- PLUS ----------
        Type: Box(8)
        Num   Action                                           Min      Max
        0     The duration of stage_0          10       30
        1     The duration of stage_1          10       30
        2     The duration of stage_2          10       30
        3     The duration of stage_3          10       30
        4     The duration of stage_4          10       30
        5     The duration of stage_5          10       30
        6     The duration of stage_6          10       30
        7     The duration of stage_7          10       30
    ...
    def step(self, action):
        """
        :param action:np.array, e.g. np.array([4, 12, 11, 13, 15, 10, 12, 16, 23]),
